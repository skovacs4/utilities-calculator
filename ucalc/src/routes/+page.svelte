...
// @ts-nocheck
  ...
  $: unitName = selectedUtility === 'electricity' ? 'kWh' : 'mc³';
</script>

<main>
  <div class="bg-gray-100 min-h-screen flex justify-center items-center">
    <div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/2 bg-white p-6 rounded-lg shadow-md flex flex-col ">
      ...
      <label for="mc3" class="block mb-2">Introduceti numarul de unitati utilizate ({unitName}):</label>
      <input
        type="number"
        id="mc3"
        class="block w-full py-2 px-3 border border-gray-300 rounded-md mb-4"
